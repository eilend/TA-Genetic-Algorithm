...
print("Penggunaan(pada terminal linux) = python, nama_program, file_input, parameter, folder_output")
class Color:
...
#PEMBENTUKKAN INDIVIDU BARU
class Transform:
    def __init__(self, target, output_path, max_loop=100000  , save_pre_loop=10000, circle_nums=100, mutate_speed=1000,
                 mutate_rate=10):
...
def main():
    ...
    parser.add_argument('target', help='gambar target')
    parser.add_argument('output', help='folder output')
    parser.add_argument('--max_loop', help='loop maksimal', type=int)
    parser.add_argument('--save_pre_loop', help='simpan loop tiap', type=int)
    parser.add_argument('--mutate_rate', help='presentase gen yang akan diganti', type=int)
    parser.add_argument('--mutate_speed', help='kecepatan mutasi', type=float)
    parser.add_argument('--circle_nums', help='banyaknya lingkaran penyusun', type=int)
    ...
    print("""Jumlah Loop: {} \t Simpan Loop tiap: {} \t Mutate Rate: {} \t Lingkaran Penyusun: {} \t Mutate Speed: {}""".format(
